...
| public | POST | `http://localhost:8080/api/auth/otp/send` |
| public | POST | `http://localhost:8080/api/auth/otp/verify` |
...
| customer | GET | `http://localhost:8080/api/customer/me` |
| driver | POST | `http://localhost:8080/api/driver/profile` |
| driver | GET | `http://localhost:8080/api/driver/me` |
